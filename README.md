...
This R code automates the calculation of Gini coefficients and summary statistics across large datasets. The code requires an input .csv file in the following format (see SampleData.csv):
